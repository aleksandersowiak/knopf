        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><div class="form-group"><label class="col-sm-1 control-label" for="title"><?=__('title')?></label>
                        <div class="col-sm-11">
                            <input type="text" required="required" id="title" name="title_<?=$this->language?>" class="form-control" placeholder="<?=__('add')?> <?=__('title')?>"/>
                        </div>
                    </div></p>
                    <textarea  id="editor" contenteditable="true" name="description_<?=$this->language?>" style="overflow: auto; display: none">
