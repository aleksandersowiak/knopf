        ...
        <?php if ($this->realization != NULL) : ?>
            <div class="page-content">
                <div class="col-md-12 col-sm-12 co-sx-12">
                    ...
                    <div class="gal-container">
                        <?php $i = 0;
                        foreach ($this->realization as $image_realization): ?>
                            <div
                                class="col-md-<?= ($i % 9) ? '2' : '4' ?> col-sm-<?= ($i % 9) ? '2' : '4' ?> co-xs-12 gal-item-prod">
                                <div
                                    class="realization imagess <?= ($image_realization['type'] == 1) ? 'images-box-' . $image_realization['id'] : 'video-box-' . $image_realization['id'] ?>">
                                    <script>
